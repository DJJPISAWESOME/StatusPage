...
try {
 ...
 await page.locator('#tv-skip').click();await page.waitForFunction(expected=>document.getElementById('tv-board').dataset.scene===expected,'weather');await page.screenshot({path:'artifacts/board-weather.png',animations:'disabled'});
 ...
 await page.locator('#tv-skip').click();await page.waitForFunction(expected=>document.getElementById('tv-board').dataset.scene===expected,'power');assert.match(await page.locator('#tv-content .tv-power-count').innerText(),/42 customers/);
 await page.locator('#tv-skip').click();await page.waitForFunction(expected=>document.getElementById('tv-board').dataset.scene===expected,'network');
