...
try {
 ...
 assert.equal(await page.locator('#tv-board').getAttribute('data-scene'),'services');assert.equal(await page.locator('#tv-content .tv-service').count(),4);
 ...
 await page.locator('#tv-skip').click();assert.equal(await page.locator('#tv-board').getAttribute('data-scene'),'weather');await page.screenshot({path:'artifacts/board-weather.png',animations:'disabled'});
 ...
 await page.getByRole('button',{name:'03 AI temperature outlook'}).click();assert.equal(await page.locator('#tv-content .tv-model-line').count(),2);await page.screenshot({path:'artifacts/board-models.png',animations:'disabled'});
 ...
 await page.locator('#tv-skip').click();assert.equal(await page.locator('#tv-board').getAttribute('data-scene'),'power');assert.match(await page.locator('#tv-content .tv-power-count').innerText(),/42 customers/);
 await page.locator('#tv-skip').click();assert.equal(await page.locator('#tv-board').getAttribute('data-scene'),'network');
