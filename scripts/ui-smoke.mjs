...
try {
 ...
 assert.equal(await page.locator('#tv-channel').innerText(),'SIGNAL / SERVICES');assert.equal(await page.locator('#tv-content .tv-service').count(),4);
 ...
 await page.locator('#tv-skip').click();assert.equal(await page.locator('#tv-channel').innerText(),'SIGNAL / POWER');assert.match(await page.locator('#tv-content .tv-power-count').innerText(),/42 customers/);
